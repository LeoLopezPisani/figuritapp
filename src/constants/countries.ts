...
export const COUNTRY_METADATA: Record<string, CountryMeta> = {
  ...
  ECU: { name: "Ecuador", group: "Group E", orderIndex: 20, total: 20 },
  NED: { name: "Netherlands", group: "Group F", orderIndex: 21, total: 20 },
  JPN: { name: "Japan", group: "Group F", orderIndex: 22, total: 20 },
  SWE: { name: "Sweden", group: "Group F", orderIndex: 23, total: 20 },
  TUN: { name: "Tunisia", group: "Group F", orderIndex: 24, total: 20 },
  ...
  ALG: { name: "Algeria", group: "Group J", orderIndex: 38, total: 20 },
